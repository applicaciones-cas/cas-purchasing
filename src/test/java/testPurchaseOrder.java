...
public class testPurchaseOrder {
    ...
    public void testSummaryList() {
        ...
        try {
            ...
            if (!"success".equals(loJSON.get("result"))) {
                System.err.println(loJSON.get("message"));
                Assert.fail();
            }

            loJSON = poPurchasingController.PurchaseOrder().RetriveSummaryReports(
                    true,
            ...
            if ("success".equals(loJSON.get("result"))) {
                ...
                System.out.println("RESULT : " + loJSON.get("message"));

                JSONArray data = (JSONArray) loJSON.get("data");
                ...
                for (int i = 0; i < data.size(); i++) {
                    ...
                    System.out.println("Supplier    : " + record.get("Supplier"));
                    System.out.println("Destination : " + record.get("Destination"));
                    System.out.println("Branch      : " + record.get("Branch"));
                    System.out.println("Transaction : " + record.get("sTransNox"));
                    System.out.println("Refernce No : " + record.get("sRefernox"));
                    System.out.println("Trans. Date : " + record.get("dTransact"));
                    System.out.println("Category    : " + record.get("Category"));
                    System.out.println("Term        : " + record.get("Term"));
                    System.out.println("Tran. Total : " + record.get("Total"));
    ...
    @Test
    public void testSummaryDetailList() {
        ...
        try {
            ...
            loJSON = poPurchasingController.PurchaseOrder()
                    .RetriveSummaryDetailedReports(
                            true,
                            LocalDate.of(2026, 1, 1),
                            LocalDate.of(2026, 5, 31),"","","",""
                    );
            ...
            if ("success".equals(loJSON.get("result"))) {
                ...
                for (int i = 0; i < data.size(); i++) {
                    ...
                    System.out.println("Transaction : " + record.get("sTransNox"));
                    System.out.println("Trans. Date : " + record.get("dTransact"));
                    System.out.println("Brand       : " + record.get("Brand"));
                    System.out.println("Model Code  : " + record.get("ModelCode"));
                    System.out.println("Model Name  : " + record.get("ModelName"));
                    System.out.println("Color       : " + record.get("Color"));
                    System.out.println("Qty         : " + record.get("Quantity"));
                    System.out.println("Unit Price  : " + record.get("UnitPrice"));
                    System.out.println("Total       : " + record.get("Total"));
...
//            }
//
//            loJSON = poPurchasingController.PurchaseOrder().OpenTransaction("GCC225000027");
//            if (!"success".equals((String) loJSON.get("result"))) {
//                System.err.println((String) loJSON.get("message"));
//                Assert.fail();
//            }
