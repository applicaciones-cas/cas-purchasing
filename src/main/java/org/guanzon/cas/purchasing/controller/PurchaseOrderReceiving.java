...
public class PurchaseOrderReceiving extends Transaction{ 
    ...
    public JSONObject SearchTrucking(String value, boolean byCode) throws ExceptionInInitializerError{
        Client object = new ClientControllers(poGRider, logwrapr).Client();
        object.Master().setRecordStatus(RecordStatus.ACTIVE);
    ...
    public JSONObject SearchBarcode(String value, boolean byCode, int row) throws ExceptionInInitializerError{
    ...
    public JSONObject SearchSupersede(String value, boolean byCode, int row) throws ExceptionInInitializerError{
        Inventory object = new InvControllers(poGRider, logwrapr).Inventory();
        object.getModel().setRecordStatus(RecordStatus.ACTIVE);
    ...
    public JSONObject SearchDescription(String value, boolean byCode, int row) throws ExceptionInInitializerError{
        Inventory object = new InvControllers(poGRider, logwrapr).Inventory();
        object.getModel().setRecordStatus(RecordStatus.ACTIVE);
    ...
    public JSONObject SearchBrand(String value, boolean byCode, int row) throws ExceptionInInitializerError{
    ...
    public JSONObject SearchModel(String value, boolean byCode, int row) throws ExceptionInInitializerError{
...
//    }
    ...
    public JSONObject getApprovedPurchaseOrder() {
        ...
        lsSQL.append(" ORDER BY dTransact ASC");
    ...
    private Model_PO_Master PurchaseOrderMaster(String transactionNo) {
