 ...
 */
public class PurchaseOrderReturn_Appliances implements GValidator{
    GRiderCAS poGrider;
    String psTranStat;
    JSONObject poJSON;
    ...
    public JSONObject validate() {
        try {
            ...
            Logger.getLogger(PurchaseOrderReturn_Appliances.class.getName()).log(Level.SEVERE, null, ex);
